...
describe('BasicInfo', () => {
  ...
  it('renders service name input', () => {
    render(<BasicInfo service={initialService} setService={mockSetService} />)
    // The label is tied via htmlFor="service_name"
  ...
  it('calls setService with updated service_name when text is typed', () => {
    ...
    // setService is called with an updater function; invoke it and inspect result
  ...
  it('reflects the current service_name value in the input', () => {
    ...
    render(<BasicInfo service={serviceWithName} setService={mockSetService} />)
